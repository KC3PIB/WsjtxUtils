# WsjtxUtils
A class library and usage examples related to interacting with [WSJT-X](https://wsjt.sourceforge.io/wsjtx.html) through the UDP interface in .NET and .NET Framework. This library allows for parsing and creating WSJT-X >= 2.2 messages and a lightweight UDP server that supports reading and writing WSJT-X messages utilizing async/await.
