...
///     than 100.
///     Using a callsign of "CLEARALL!" and anything for the color values will clear the internal highlighting data. It
///     will NOT remove the highlighting on the screen, however. The exclamation symbol is used to avoid accidental
///     clearing of all highlighting data via a decoded callsign, since an exclamation symbol is not a valid character in a
///     callsign.
/// </remarks>
public class HighlightCallsign : WsjtxMessage, IWsjtxDirectionIn
{
    ...
    public HighlightCallsign(string id, string callsign, Color backgroundColor, Color foregroundColor,
        bool highlightLast = false) : this(id, callsign, QColor.FromSystemDrawingColor(backgroundColor),
        QColor.FromSystemDrawingColor(foregroundColor), highlightLast)
    {
    }
    ...
    /// <param name="foregroundColor"></param>
    /// <param name="highlightLast"></param>
    public HighlightCallsign(string id, string callsign, QColor backgroundColor, QColor foregroundColor,
        bool highlightLast = false) : base(id, MessageType.HighlightCallsign)
    {
        Callsign = callsign;
